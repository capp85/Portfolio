...
const cards = [
  ...
  },
  {
    ...
    technology:
      'Technology: Express, Express Handle-Bars, MySQL, Node, ORM, MVC, Heroku',
    site: 'https://serene-reaches-79263.herokuapp.com/',
    code: 'https://github.com/capp85/burger'
  }
];
                ...
                <Grid item key={index} xs={12} sm={6} md={4}>
                  <Card className={classes.card}>
                    ...
                    <CardContent className={classes.cardContent}>
                      <Typography className={classes.technology}>
                        {card.technology}
                      </Typography>
                    </CardContent>
